...
### Next: `DARS-LIVE-RELEASE-R5-UNATTENDED-PREP`
...
- `docs/runbooks/dars-unattended-advisory-operation.md` (new) — PREP scope: standing approval policy contract, runner procedure, dry-run rehearsal procedure, circuit breaker matrix, post-run human review.
- `docs/examples/dars/unattended-standing-approval.example.json` (new) — sample standing approval policy that passes the validator.
- updates to `docs/traceability/dars-critic-panel-runtime-traceability.md` and ralph.md.
...
- Current HEAD: 88036cd (pre-R4-commit)
