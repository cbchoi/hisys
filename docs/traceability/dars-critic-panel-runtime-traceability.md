...
- Evidence contract: accepted claim is `release_package_registry_upload_scope_discarded`; `operator_decision=registry_and_package_upload_not_planned`; `registry_policy_details_required=false`; `composite_upload_approval_packet_retired=true`; `package_upload_scope_retired=true`; `pypi_registry_use_planned=false`; `testpypi_registry_use_planned=false`; `upload_command_scope_retired=true`; `package_registry_interaction_scope_retired=true`; `registry_target_selected=false`; `registry_url_resolved=false`; `distribution_artifact_built=false`; `build_command_executed=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
...
- Artifacts: `docs/release/dars-release-package-upload-registry-artifact-approval-packet-incomplete-v0.0.115.md`, `docs/release/dars-panel-release-notes-v0.0.115.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.115.md`, `tests/unit/test_dars_release_package_upload_registry_artifact_approval_packet_incomplete.py`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_package_upload_registry_artifact_approval_packet_incomplete`; `approval_tokens_received=true`; `approval_policy_details_received=false`; `composite_approval_packet_complete=false`; `registry_human_approval_recorded=false`; `artifact_build_human_approval_recorded=false`; `version_alignment_human_approval_recorded=false`; `registry_target_selected=false`; `registry_url_resolved=false`; `distribution_artifact_built=false`; `distribution_artifact_verified=false`; `distribution_artifact_hash_recorded=false`; `package_version_alignment_verified=false`; `build_command_executed=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 remains at `DARS-LIVE-RELEASE-PACKAGE-UPLOAD-REGISTRY-ARTIFACT-EXACT-APPROVAL`; token receipt alone is not enough to select registry policy, build artifacts, verify version alignment, or execute upload.
- Boundary: no artifact build, upload command, package registry interaction, credential lookup, deployment, publication, external notification, live provider/model call, raw provider API call, standing unattended activation, branch rewrite, force push, or human-review removal is introduced.

## DARS-LIVE-RELEASE-PACKAGE-UPLOAD-REGISTRY-ARTIFACT-EXACT-APPROVAL — exact approval missing

- Scope: after the v0.0.113 registry/artifact human gate, the assistant presented a single composite approval packet and the operator instructed `진행`. This records that the composite approval packet was not supplied and keeps the same exact-approval gate open.
- Artifacts: `docs/release/dars-release-package-upload-registry-artifact-exact-approval-missing-v0.0.114.md`, `docs/release/dars-panel-release-notes-v0.0.114.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.114.md`, `tests/unit/test_dars_release_package_upload_registry_artifact_exact_approval_missing.py`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_package_upload_registry_artifact_exact_approval_missing`; `previous_assistant_presented_single_packet=true`; `composite_approval_packet_received=false`; `registry_human_approval_recorded=false`; `artifact_build_human_approval_recorded=false`; `version_alignment_human_approval_recorded=false`; `registry_target_selected=false`; `registry_url_resolved=false`; `distribution_artifact_built=false`; `distribution_artifact_verified=false`; `distribution_artifact_hash_recorded=false`; `package_version_alignment_verified=false`; `build_command_executed=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 remains at `DARS-LIVE-RELEASE-PACKAGE-UPLOAD-REGISTRY-ARTIFACT-EXACT-APPROVAL`, where the registry, artifact build, and version-alignment exact approvals must be recorded before any build or upload-oriented action.
- Boundary: no artifact build, upload command, package registry interaction, credential lookup, deployment, publication, external notification, live provider/model call, raw provider API call, standing unattended activation, branch rewrite, force push, or human-review removal is introduced.

## DARS-LIVE-RELEASE-PACKAGE-UPLOAD-REGISTRY-AND-ARTIFACT-HUMAN-GATE — registry/artifact gate entered

- Scope: after the v0.0.112 command preflight, the operator instructed `go`. This enters the registry/artifact human gate and requires explicit approval of registry target, artifact build boundary, and package version-alignment basis before build, upload, registry interaction, or credential lookup.
- Artifacts: `docs/release/dars-release-package-upload-registry-artifact-human-gate-v0.0.113.md`, `docs/release/dars-panel-release-notes-v0.0.113.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.113.md`, `tests/unit/test_dars_release_package_upload_registry_artifact_gate.py`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_package_upload_registry_artifact_human_gate_entered`; `registry_artifact_human_gate_entered=true`; `registry_target_selected=false`; `registry_url_resolved=false`; `registry_human_approval_recorded=false`; `artifact_build_human_approval_recorded=false`; `version_alignment_human_approval_recorded=false`; `distribution_artifact_built=false`; `distribution_artifact_verified=false`; `distribution_artifact_hash_recorded=false`; `package_version_alignment_verified=false`; `build_command_executed=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now advances to `DARS-LIVE-RELEASE-PACKAGE-UPLOAD-REGISTRY-ARTIFACT-EXACT-APPROVAL`, where the registry, artifact build, and version-alignment exact approvals must be recorded before any build or upload-oriented action.
- Boundary: no artifact build, upload command, package registry interaction, credential lookup, deployment, publication, external notification, live provider/model call, raw provider API call, standing unattended activation, branch rewrite, force push, or human-review removal is introduced.
...
## DARS-LIVE-RELEASE-PACKAGE-UPLOAD-INSTRUCTION-OVERRIDE — override accepted for command preflight (2026-05-25)

- Scope: after the v0.0.110 missing-exact-token gate, the operator challenged the exact-token requirement and instructed `override` because the prior utterance `execute package upload v0.0.110` had already named the action and version. The override accepts that prior utterance only for advancing to command-boundary preflight.
- Artifacts: `docs/release/dars-release-package-upload-instruction-override-v0.0.111.md`, `docs/release/dars-panel-release-notes-v0.0.111.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.111.md`, `tests/unit/test_dars_release_package_upload_instruction_override.py`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_package_upload_instruction_override_accepted_for_command_preflight`; `override_operator_instruction=override`; `overridden_prior_instruction=execute package upload v0.0.110`; `operator_override_exact_token_requirement=true`; `package_upload_execution_instruction_received=true`; `package_upload_command_preflight_required=true`; `credential_lookup_by_hisys=false`; `deployment_authorized=false`; `publication_authorized=false`; `external_notification_authorized=false`; `live_external_action_authorized=false`; `live_model_call_authorized=false`; `raw_provider_api_call_by_hisys=false`; `standing_unattended_approval_activated=false`; `human_review_removal_authorized=false`; `force_push_authorized=false`; `branch_rewrite_authorized=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now advances to `DARS-LIVE-RELEASE-PACKAGE-UPLOAD-COMMAND-PREFLIGHT`, where command, registry, credential-reference, and stop-condition boundaries must be validated before any upload action.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, package upload execution, package registry interaction, deployment, publication, external notification, branch rewrite, force push, or human-review removal is introduced.

## DARS-LIVE-RELEASE-PACKAGE-UPLOAD-SCOPED-EXECUTION-INSTRUCTION-GATE — scoped instruction missing (2026-05-25)

- Scope: after the v0.0.109 execution decision packet, the operator instructed `go`, then later instructed `execute`, then later instructed `execute package upload v0.0.110`. At the scoped execution instruction gate, none of these phrases exactly matches `EXECUTE-PACKAGE-UPLOAD-v0.0.110`; this records the missing exact scoped instruction and keeps the gate open.
- Artifacts: `docs/release/dars-release-package-upload-scoped-execution-instruction-missing-v0.0.110.md`, `docs/release/dars-panel-release-notes-v0.0.110.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.110.md`, `tests/unit/test_dars_release_package_upload_scoped_execution_instruction_gate.py`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_package_upload_scoped_execution_instruction_missing`; `operator_instruction=go`; `followup_operator_instruction=execute`; `second_followup_operator_instruction=execute package upload v0.0.110`; `scoped_package_upload_execution_instruction_required=true`; `scoped_package_upload_execution_instruction_received=false`; `followup_instruction_scoped_package_upload_execution=false`; `second_followup_exact_required_instruction_matched=false`; `second_followup_instruction_scoped_package_upload_execution=false`; `required_exact_execution_instruction=EXECUTE-PACKAGE-UPLOAD-v0.0.110`; `package_upload_execution_instruction_received=false`; `credential_lookup_by_hisys=false`; `deployment_authorized=false`; `publication_authorized=false`; `external_notification_authorized=false`; `live_external_action_authorized=false`; `live_model_call_authorized=false`; `raw_provider_api_call_by_hisys=false`; `standing_unattended_approval_activated=false`; `human_review_removal_authorized=false`; `force_push_authorized=false`; `branch_rewrite_authorized=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 remains at the scoped execution instruction gate until the exact instruction `EXECUTE-PACKAGE-UPLOAD-v0.0.110` is supplied and a later execution packet validates command boundaries.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, package upload execution, package registry interaction, deployment, publication, external notification, branch rewrite, force push, or human-review removal is introduced.

## DARS-LIVE-RELEASE-PACKAGE-UPLOAD-EXECUTION-DECISION-PACKET — execution decision approved (2026-05-25)

- Scope: after the v0.0.108 package-upload authorization packet, the operator instructed `go`. This records the package-upload execution decision packet for human review and moves the release line to a scoped execution instruction gate.
- Artifacts: `docs/release/dars-release-package-upload-execution-decision-packet-v0.0.109.md`, `docs/release/dars-panel-release-notes-v0.0.109.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.109.md`, `tests/unit/test_dars_release_package_upload_execution_decision_packet.py`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_package_upload_execution_decision_packet_approved_for_human_review`; `operator_instruction=go`; `selected_action_set=tag_creation_and_package_upload`; `package_upload_in_selected_action_set=true`; `package_upload_authorization_packet_approved=true`; `package_upload_execution_decision_packet_approved=true`; `package_upload_execution_instruction_received=false`; `deployment_authorized=false`; `publication_authorized=false`; `external_notification_authorized=false`; `live_external_action_authorized=false`; `live_model_call_authorized=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `standing_unattended_approval_activated=false`; `human_review_removal_authorized=false`; `force_push_authorized=false`; `branch_rewrite_authorized=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now has a package-upload execution-decision packet; the next row is the separately gated `DARS-LIVE-RELEASE-PACKAGE-UPLOAD-SCOPED-EXECUTION-INSTRUCTION-GATE`.
...
- Scope: after the post-tag-push review packet, the queued `DARS-LIVE-RELEASE-PACKAGE-UPLOAD-AUTHORIZATION-PACKET` cannot advance without scoped operator approval because the selected action set is `tag_creation_only` and no package-upload approval instruction has been recorded. This preflight records the gate state, names exact scoped approval templates, and preserves every existing release-action lockout.
- Artifacts: `docs/release/dars-release-package-upload-authorization-preflight-v0.0.107.md`, `docs/release/dars-panel-release-notes-v0.0.107.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.107.md`, `tests/unit/test_dars_release_package_upload_authorization_preflight.py`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_package_upload_authorization_packet_preflight_recorded_for_human_review`; `selected_action_set=tag_creation_only`; `package_upload_in_selected_action_set=false`; `package_upload_authorization_packet_approved=false`; `package_upload_authorization_packet_preflight_recorded=true`; `operator_instruction_for_package_upload_received=false`; `exact_approval_token_for_scope_expansion=APPROVE-PACKAGE-UPLOAD-SCOPE-EXPANSION-v0.0.107`; `exact_approval_token_for_authorization_packet=APPROVE-PACKAGE-UPLOAD-AUTHORIZATION-PACKET-v0.0.107`; `deployment_authorized=false`; `publication_authorized=false`; `external_notification_authorized=false`; `live_external_action_authorized=false`; `live_model_call_authorized=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `standing_unattended_approval_activated=false`; `human_review_removal_authorized=false`; `force_push_authorized=false`; `branch_rewrite_authorized=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now has a package-upload authorization-packet preflight and a next exact-approval gate; the queued package-upload authorization packet remains separately gated on scoped operator approval.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, package upload, deployment, publication, external notification, branch rewrite, force push, scope expansion, or human-review removal is introduced.
...
- Evidence contract: accepted claim is `release_tag_push_reviewed_for_human_review_no_additional_action`; `tag_name=v0.0.103`; `tag_target_commit=ea26df6`; `remote_tag_ref=refs/tags/v0.0.103`; `remote_tag_object=1b94bf8da8d9fdd43201ee05b44558d2c9787789`; `remote_tag_peeled_commit=ea26df63f8705faf178b0860ff9f17090ba0b8c3`; `tag_push_reviewed=true`; `additional_release_action_authorized=false`; `additional_release_action_performed=false`; `deployment_authorized=false`; `publication_authorized=false`; `external_notification_authorized=false`; `live_external_action_authorized=false`; `live_model_call_authorized=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
...
- Artifacts: `docs/release/dars-release-tag-creation-execution-decision-packet-v0.0.104.md`, `docs/release/dars-panel-release-notes-v0.0.104.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.104.md`, `tests/unit/test_dars_release_tag_creation_execution_decision.py`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_tag_creation_executed_for_local_repository_only`; `selected_action_set=tag_creation_only`; `tag_name=v0.0.103`; `tag_target_commit=ea26df6`; `tag_kind=annotated`; `tag_creation_authorized=true`; `tag_creation_performed=true`; `tag_push_authorized=false`; `tag_push_performed=false`; `deployment_authorized=false`; `publication_authorized=false`; `external_notification_authorized=false`; `live_external_action_authorized=false`; `live_model_call_authorized=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 advances to the tag-push authorization packet; remote tag push remains a separate authorization and execution step.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, remote tag push, package upload, deployment, publication, external notification, mutation outside the local repository tag/docs/tests/control files, or human-review removal is introduced.
...
- Scope: after release action authorization packet approval, the operator instructed `다음`. This records the finite candidate action set for human review without selecting or authorizing any action.
- Artifacts: `docs/release/dars-release-specific-action-selection-packet-v0.0.100.md`, `docs/release/dars-panel-release-notes-v0.0.100.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.100.md`, `tests/unit/test_dars_release_specific_action_selection_packet.py`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `release_specific_action_candidate_set_recorded_for_human_review`; `selected_action_set=none`; `specific_action_selection_approved=false`; `release_action_authorized=false`; `release_action_performed=false`; `tag_creation_authorized=false`; `deployment_authorized=false`; `publication_authorized=false`; `live_external_action_authorized=false`; `live_model_call_authorized=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now has a candidate action set and a next specific-action approval gate.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, release tag/package/upload/deploy/publication, external notification, mutation outside repository docs/tests/control files, or human-review removal is introduced.
...
- Scope: after the residual-risk explanation and gate-entry record, the operator responded `승인`. This record accepts the residual risk only for using the current non-live, human-reviewed evidence package in a later RC readiness acceptance packet.
- Artifacts: `docs/release/dars-r7-rc-residual-risk-exact-approval-v0.0.95.md`, `docs/release/dars-panel-release-notes-v0.0.95.md`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.95.md`, `tests/unit/test_dars_r7_rc_residual_risk_exact_approval.py`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `r7_rc_residual_risk_scope_accepted_for_human_review`; `human_residual_risk_acceptance=accepted`; `release_candidate_ready=false`; `released_for_controlled_advisory_use=false`; `release_execution_authorized=false`; `r5_live_canary_executed=false`; `bounded_unattended_advisory_operation_ready=false`; `live_provider_model_call_made=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now has residual-risk acceptance and a next RC readiness acceptance packet.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, release tag/package/upload/deploy/publication, external notification, mutation outside repository docs/tests/control files, or human-review removal is introduced.

## DARS-LIVE-RELEASE-R7-RC-RESIDUAL-RISK-HUMAN-GATE — residual-risk gate entered, exact approval required (2026-05-24)

- Scope: after the operator named the residual-risk human gate, recorded the gate-entry packet and exact approval text required for any later residual-risk acceptance. The gate entry does not substitute for approval.
- Artifacts: `docs/release/dars-r7-rc-residual-risk-human-gate-v0.0.94.md`, `docs/release/dars-panel-release-notes-v0.0.94.md`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.94.md`, `tests/unit/test_dars_r7_rc_residual_risk_human_gate.py`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `r7_rc_residual_risk_human_gate_entered`; `human_residual_risk_acceptance=not_recorded`; exact approval text is required; `release_candidate_ready=false`; `release_execution_authorized=false`; `r5_live_canary_executed=false`; `bounded_unattended_advisory_operation_ready=false`; `live_provider_model_call_made=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now has a human residual-risk gate-entry record and a next exact-approval gate.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, release tag/package/upload/deploy/publication, external notification, mutation outside repository docs/tests/control files, or human-review removal is introduced.

## DARS-LIVE-RELEASE-R7-RC-READINESS-DECISION-PACKET — RC readiness decision packet recorded, readiness not upgraded (2026-05-24)

- Scope: after the R5 fake/injected-transport canary post-run review gate accepted its bounded claim, recorded the release-candidate readiness decision packet for human review. The packet uses the R4H scoped substitute and reviewed R5 fake-transport canary evidence while preserving missing live-provider/model canary evidence and missing residual-risk acceptance as blockers.
- Artifacts: `docs/release/dars-r7-rc-readiness-decision-packet-v0.0.93.md`, `docs/release/dars-panel-release-notes-v0.0.93.md`, `docs/release/dars-panel-release-candidate-checklist.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.93.md`, `tests/unit/test_dars_r7_rc_readiness_decision_packet.py`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `r7_rc_readiness_decision_packet_recorded_for_human_review`; prior accepted evidence includes `r4h_hermes_mediated_request_response_harness_closed_for_human_review` and `r5_fake_transport_canary_post_run_review_accepted`; `release_candidate_ready=false`; `bounded_unattended_advisory_operation_ready=false`; `r5_live_canary_executed=false`; `live_provider_model_call_made=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `human_residual_risk_acceptance=missing`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-015 / HISYS-T-DARS-CP-017 now has a no-go RC readiness decision packet and a next human residual-risk gate.
- Boundary: no live provider/model call, Codex subprocess retry, raw provider API call, credential lookup, standing unattended activation, release tag/package/upload/deploy/publication, external notification, mutation outside repository docs/tests/control files, or human-review removal is introduced.

## DARS-LIVE-RELEASE-R5-CANARY-MODE-PREP — R5 canary-mode contract prepared for human review (2026-05-24)

- Scope: implemented a distinct local `mode=canary` contract for the bounded unattended runner after the previous canary attempt was blocked by the dry-run-only PREP request-class allowlist. The canary mode validates canary-specific standing-approval fields, rejects non-canary request classes in canary mode, and preserves the existing dry-run path.
- Artifacts: `src/hisys/agents/dars_unattended_policy.py`, `src/hisys/operations/dars_unattended_runner.py`, `docs/examples/dars/unattended-standing-approval-canary.example.json`, `docs/runbooks/dars-unattended-advisory-operation.md`, `docs/reports/dars-r5-canary-mode-contract-2026-05-24.md`, `docs/milestone-bootstrap/documents/readiness_decision_record_v0.0.89.md`, `tests/unit/test_dars_unattended_policy.py`, `tests/unit/test_dars_unattended_runner.py`, `tests/unit/test_dars_unattended_docs.py`, `docs/milestone-bootstrap/profile.yaml`, `ralph.md`, and `tests/unit/test_governance_docs_current_state.py`.
- Evidence contract: accepted claim is `r5_canary_mode_contract_prepared_for_human_review`; `r5_live_canary_executed=false`; `standing_unattended_approval_activated=false`; `bounded_unattended_advisory_operation_ready=false`; `release_candidate_ready=false`; `live_provider_model_call_made=false`; `raw_provider_api_call_by_hisys=false`; `credential_lookup_by_hisys=false`; `requires_human_review=true`.
- Traceability: HISYS-FR-DARS-CP-013 / HISYS-T-DARS-CP-015 now has canary-mode contract tests and docs. The next safe task is `DARS-LIVE-RELEASE-R5-CANARY-EXECUTION-HUMAN-GATE`.
- Boundary: no live provider/model call, Codex subprocess critic call, raw provider API call, credential lookup, standing unattended approval activation, release tag/package/upload/deploy/publication, external notification, mutation outside repository docs/tests/control files, or human-review removal was introduced.
...
| HISYS-FR-DARS-CP-015 | release checklist, release notes, release scope decision packet, RC readiness decision packet, residual-risk human gate, residual-risk exact approval, post-release smoke evidence | HISYS-T-DARS-CP-017 | `test_release_candidate_checklist_requires_prior_live_unattended_and_rollback_evidence`; `test_rc_scope_decision_preserves_claim_ladder_and_blocks_release_actions`; `test_rc_readiness_packet_records_no_go_claim_boundary`; `test_residual_risk_gate_records_gate_entered_without_approval_substitution`; `test_residual_risk_exact_approval_accepts_only_residual_risk_scope`; release decision packet review | RESIDUAL-RISK-ACCEPTED + RC READINESS ACCEPTANCE PACKET PLANNED (DARS-LIVE-RELEASE-R7; `release_candidate_ready=false`) |
