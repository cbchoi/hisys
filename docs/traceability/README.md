...
envelope validator, DARS backend/role config contract, and canonical
Hisys↔DARS request/response data-format contract. Investigator multi-agent fixture
