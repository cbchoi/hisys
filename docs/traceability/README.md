...
| `hisys.config.obsidian_live` Git lifecycle plans | HISYS-FR-MEM-001..005, HISYS-FR-INV-001..006, HISYS-CON-010..012, HISYS-CON-022..023 | `tests/unit/test_obsidian_git_management.py` |
