...
validation reports, and `hisys.agents.dars_trace` source/memo/alert/evidence-to-critique lineage artifacts. Investigator multi-agent fixture
...
| `hisys.agents.dars_backend` | HISYS-DARS-CONTRACT-001, HISYS-FR-AGT-001..005, HISYS-T-019, HISYS-T-020, HISYS-T-024, HISYS-CON-010..012 | `tests/unit/test_dars_backend.py` |
